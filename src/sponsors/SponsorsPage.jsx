  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div
          className="absolute top-2/3 right-0 w-1/2 h-0.5 bg-purple-400 opacity-50"
          style={{ animation: "glitch-flash 5s infinite" }}
        ></div>
        <div
          className="absolute top-1/3 left-0 w-1/2 h-0.5 bg-yellow-400 opacity-50"
          style={{ animation: "glitch-flash 5s infinite" }}
        ></div>
        ...
        <div
          className="absolute top-3/4 right-1/4 w-1 h-1 bg-pink-500 rounded-full animate-ping"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-3/4 w-1 h-1 bg-yellow-400 rounded-full animate-ping"
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          >
            ...
            {/* Glitch effect lines */}
            <div
              className="absolute top-0 left-0 w-full h-0.5 bg-cyan-400 opacity-0 group-hover:opacity-60 transition-opacity duration-300"
              style={{ animation: "glitch-flash 2s infinite" }}
            ></div>
            <div
              className="absolute bottom-0 right-0 w-1/2 h-0.5 bg-pink-500 opacity-0 group-hover:opacity-40 transition-opacity duration-300"
              style={{
        ...
        <div className="text-center mb-16">
          <h1 className="lg:text-7xl text-6xl font-black mb-6 relative">
            <span
              className="bg-gradient-to-r from-cyan-400 via-pink-500 to-purple-500 bg-clip-text text-transparent animate-pulse"
              style={{ fontFamily: "CyberAlert" }}
            >
              SPONSORS
            </span>
            <div
              className="absolute -top-1 left-0 text-6xl lg:text-7xl font-black text-cyan-400 opacity-20 blur-sm"
              style={{ fontFamily: "CyberAlert" }}
            >
              SPONSORS
            </div>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2
              className="lg:text-4xl text-3xl font-bold text-yellow-400 tracking-wider"
              style={{ fontFamily: "CyberAlert" }}
            >
              PARTNERS
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {partners.map((sponsor, index) => (
              <div key={index} className="group relative">
                <div
                  className="bg-gray-900/60 border border-yellow-500 h-40 w-full max-w-[420px] mx-auto 
                      transform transition-all duration-500 hover:scale-110 hover:border-cyan-400 
                      hover:shadow-xl hover:shadow-yellow-500/30 backdrop-blur-md relative overflow-hidden"
                >
                  <img
                    src={sponsor.logo}
                    alt="Sponsor"
                  ...
                  <div className="absolute top-2 right-2 w-2 h-2 bg-yellow-500 animate-pulse"></div>
                  <div
                    className="absolute -inset-1 bg-gradient-to-r from-pink-500 to-purple-500 
                        opacity-0 group-hover:opacity-20 blur-lg transition-opacity duration-500"
                  ></div>
                </div>
              </div>
            ))}
