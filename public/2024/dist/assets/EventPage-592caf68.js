import{j as e,_ as t,b as P,r as d,L as T}from"./index-31c96ade.js";import{d as _,I as s}from"./event_image-0b348d67.js";import{m as p}from"./motion-d9490506.js";const r=({name:i,desc:o,mode:c})=>{const u=c==="1"?"border-red1":c==="2"?"border-blue1":"border-gray-500";return e.jsxs("div",{className:"flex flex-col h-screen justify-center items-center gap-10 text-left",children:[e.jsx("div",{className:"text-4xl md:text-6xl font-bold text-white",children:i}),e.jsx("div",{className:`whitespace-pre-line overflow-scroll no-scrollbar border-2 ${u} p-4 mx-16 md:mx-32 lg:mx-64 text-sm text-left md:text-lg`,children:o})]})},l=({openNavigation:i,children:o})=>e.jsx("div",{children:i&&e.jsx("div",{className:"absolute w-screen h-screen md:-top-[27vh] md:-left-1/3 left-0 top-0 backdrop-filter backdrop-blur-lg bg-opacity-10 bg-neutral-900 flexCenter flex-col text-center",children:o})}),I=[{route:"/event_day1/1",name:"Pitching Pixels 2.0",about:"Put your entrepreneurial skills to the test and compete with top rising talents in the business world. Pitch your game-changing ideas.",rules:"Discuss the significance of the problem and proposed solution, the needs addressed, and the target market. Highlight the unique features that differentiate your solution from existing options. Lastly, outline the business model, including revenue generation, pricing strategy, and distribution channels.",impInfo:`• Mode: Online
• Team Size: 1-3
• Prize Pool: 20k
...
`,contact:"Parthiv ECELL 9883015685",link:"https://unstop.com/o/5XselW8?lb=JZ5h6co3&utm_medium=Share&utm_source=shortUrl",imageName:"bidbuild"},{route:"/event_day1/4",name:"MERNify",about:"MERNify is a 24hr full-stack development hackathon where the brightest engineering minds can come together to solve real-life problems that have a meaningful impact.  Judge of the Hackathon is 2007 - IIITB Alumnus, Imanp`reet Singh Arora. He will also remotely mentor the participants via discord.",rules:`1. Eligibility
...
• Rounds: 1 round
• Theme: Pixel-Art 
• Problem Statement: Gamified Language Learning App Models required to be used: Llama or Gemini Frontend: React Native or Flutter Backend: Django, MERN, flask, spring etc.  Databse: MongoDB or MySQL (for Django dsqlite3 databse will be accepted), or firebase database   Important Note: Using Firebase for full backend process is not acceptable, there should be some backend component which the participant has designed (coded)    `,contact:"Subhranil Basak  | A Bansal 8451979163",link:"https://forms.office.com/Pages/ResponsePage.aspx?id=IkyogrJHEka594YPOeubElw_fKQ11W5PkGb_NeEkHB1UQzFUVzRIT083TTZLRlpTT1VUNzY5MllDQy4u",imageName:"mernify"},{route:"/event_day1/5",name:"Deep Reality",about:"Can you identify whether a image,video,audio is real or generated by AI? If yes, then this event is for you",rules:`1. Eligibility
...
`,contact:"Sriram (63627 92963) Akshat (91335 68951)",link:"https://forms.office.com/Pages/ResponsePage.aspx?id=IkyogrJHEka594YPOeubElw_fKQ11W5PkGb_NeEkHB1UQzQyMldBSDFHVldGWVJZRVlYTTFSQ1BGWS4u",imageName:"deepReality"},{route:"/event_day1/6",name:"Lockout Duel 2.0",about:"Think you're fast at solving coding problems? Prove it in Lockout Duel 2.0 -  a knockout challenge where you face off one-on-one, and the first to solve wins. The last one standing takes it all!",rules:`- Participation is limited to IIIT-B students no external participants are allowed
...
Naitik Solanki(7016740700)`,link:"https://forms.office.com/Pages/ResponsePage.aspx?id=IkyogrJHEka594YPOeubElw_fKQ11W5PkGb_NeEkHB1UMjVCUEZQRFQ2NFhNMU81MVI2WjhQQktPVy4u",imageName:"lockoutDuel"},{route:"/event_day2/1",name:"Dappathon",about:"A 12hr Web3 Hackathon to Learn, Buidl, and Earn on Aptos Aptos x Spheron x IBW brings you day dappAthons a series of 12-hour hackathons for students, where you can learn, build, and ship a project on Aptos",rules:"Complemented with informative workshops, enjoyable mini-games, cool prizes, and pizzas to eat.",impInfo:`• Mode: Offline
• Team Size: 1-3
• Prize Pool: $1k
...
• Registration Timeline: 10 Nov
• Rounds: 1 Round
`,contact:"Varshith (9886987649), Nathan (8848839946)",link:"https://docs.google.com/forms/d/e/1FAIpQLScH-clXkyoGdMIlHYsp9OG3JahL-hhRa6JZV1PwrsIgB7zUQQ/viewform",imageName:"lensFlare"},{route:"/event_day3/3",name:"ML-Fiesta",about:"ML-Fiesta is our AI/ML hackathon where the brightest engineering minds can come together to solve real-life problems that have a meaningful impact.",rules:"Please refer to the detailed problem statement to understand the rules. The judges retain the right to withhold prizes if submissions do not meet the expected standards",impInfo:`• Mode: Online
• Team Size: 1-3
• Prize Pool: 60k
