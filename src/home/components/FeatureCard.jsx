...
const FeatureCard = ({ title, description, icon }) => (
    <div className="group relative">
      ...
      <div className="relative bg-black/60 border border-cyan-400/20 rounded-xl p-6 backdrop-blur-sm hover:border-cyan-400/40 transition-all duration-300 h-full">
        ...
        {/* Content */}
        <h3 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "CyberAlert" }}>{title}</h3>
        <p className="text-gray-400 leading-relaxed" style={{ fontFamily: "CyberAlert" }}>{description}</p>
