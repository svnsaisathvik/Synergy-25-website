        ...
        <button
          ...
          className={`relative block text-xl md:text-2xl font-medium transition-all duration-300 ${
            activeCategory === category 
              ...
              : 'text-gray-400 hover:text-cyan-300 hover:translate-x-1'
          }`}
        >
          ...
          {activeCategory === category && (
            <>
              <span className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-2 h-8 bg-gradient-to-r from-cyan-400 to-purple-500"></span>
